...
purely native PHP ! The Resturant skeleton tries to be the extremely slimmed down opposite of big frameworks
...
Have a look here: https://github.com/panique/Resturant-advanced
...
There's a tutorial on [How to install Resturant on Windows 7, 8 and 8.1](http://www.dev-metal.com/install-Resturant-windows-7/).
...
```
git clone https://github.com/panique/Resturant.git /var/www
```

or c) getting the repo via Composer (here we copy into var/www)

```
composer create-project panique/Resturant /var/www dev-master
```
...
```php
define('URL', 'http://127.0.0.1/Resturant/');
```
...
![Resturant introduction tutorial - page 1](_tutorial/tutorial-part-01.png)
![Resturant introduction tutorial - page 2](_tutorial/tutorial-part-02.png)
![Resturant introduction tutorial - page 3](_tutorial/tutorial-part-03.png)
![Resturant introduction tutorial - page 4](_tutorial/tutorial-part-04.png)
![Resturant introduction tutorial - page 5](_tutorial/tutorial-part-05.png)
...
[![Bitdeli Badge](https://d2weczhvl823v0.cloudfront.net/panique/Resturant/trend.png)](https://bitdeli.com/free "Bitdeli Badge")
