...
class Application
{
    ...
    private $url_parameter_11 = array();
    ...
    public function __construct()
    {
        ...
        if (file_exists('./application/controller/' . $this->url_controller . '.php')) {
            ...
            if (method_exists($this->url_controller, $this->url_action)) {
                ...
                } elseif (isset($this->url_parameter_11)) {
                    // will translate to something like $this->home->method($param_1, $param_2);
                    $this->url_controller->{$this->url_action}($this->url_parameter_1, $this->url_parameter_11);
    ...
    private function splitUrl()
    {
        if (isset($_GET['url'])) {
            ...
            $this->url_parameter_11 = (isset($url[5]) ? $url[5] : null);
